export function Mark({ size = 34 }: { size?: number }) {
  return (
    <svg
      ...
      style={{ flexShrink: 0 }}
    >
      <rect x="16" y="16" width="14" height="14" rx="2" fill="var(--ink)" transform="rotate(45 23 23)" />
      ...
      <rect x="30" y="30" width="12" height="12" rx="2" fill="var(--ink)" opacity="0.5" transform="rotate(45 36 36)" />
    </svg>
  );
}
