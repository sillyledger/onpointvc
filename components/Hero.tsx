  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-[56px] px-16 py-[60px] max-[768px]:px-6">
        <h1 className="text-center text-[clamp(90px,15vw,260px)] font-black leading-none tracking-[-0.02em] text-transparent [-webkit-text-stroke:2.5px_var(--ink)] [font-family:var(--font-inter)]">
