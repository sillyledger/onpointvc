...
export function SiteFooter() {
  return (
    <footer className="flex flex-wrap justify-center gap-x-20 gap-y-10 bg-ink px-12 py-12 max-[768px]:flex-col max-[768px]:items-start max-[768px]:justify-start max-[768px]:gap-8 max-[768px]:px-6">
